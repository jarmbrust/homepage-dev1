...
class Oosular extends Component {
  ...
  humans() {
    return (
      <div><h3>Humans</h3>
        <p class="tooltip">[Gameplay Note:]<span class="tooltiptext">All humans use the variant rules from the PHB: +1 to 2 ability scores of your choice,
        one extra skill proficiency, and one starting feat.</span></p>
        <p><span class="race-heading">Nokos</span>: Said to be the decedents of the ancient Nokoyans who, as legend goes, once ruled most of Oosular. 
          They generally have light to medium skin tones and darker hair and eyes.</p>
        <p><span class="race-heading">Tarok</span>: A fair hair and skinned people who live in the northern portions of the northern continent. 
        ...
        <p><span class="race-heading">Ven</span>: A darker skinned people that originally are believed to have come from the western sea and settled southern Rana. They
  ...
  elves() {
    return (
      <div>
        <h3>Elves</h3>
        <p><span class="race-heading">High Elves</span>: Claim to be the oldest and most "pure" elves, and to have once had an empire greater than Nokoya.  
        ...
        <p><span class="race-heading">Wood Elves</span>: Range from light to medium skin tones and hair from blond, brown, red, black and green. They are slim of build and stand just
        ...
        <p><span class="race-heading">Half Elves</span>: Usually of wood elf decent, they have a mixture of their parents' traits. They are generally accepted in most human communities
  ...
  dwarves() {
    return(
      <div>
        <h3>Dwarves</h3>
        <p><span class="race-heading">Hill Dwarves</span>: Most populous of the dwarves who mix with the human nations, 
        ...
        <p><span class="race-heading">Mountain Dwarves</span>: Slightly taller and fairer skinned then their hill dwarf cousins, 
  ...
  halflings() {
    return(
      <div>
        <h3>Halflings</h3>
        <p><span class="race-heading">Lightfoot</span>: Standing around 3 feet tall they are amongst the smallest of the PC races.  
        ...
        <p><span class="race-heading">Stout</span>: Tend to be stockier and darker then their cousins, and are usually 
  ...
  tieflings() {
    return(
      <div>
        <h3>Tieflings</h3>
        <p><span class="race-heading">Infernal/Abyssal</span>: All the stats and looks from the books.  Sometimes viewed with distrust, they are decedents with demonic or
          ...
          long ago.</p>
        <p><span class="race-heading">Bloodsworn</span>: Humans (usually) that have formed a direct pact with the forces of the abyss.  The have blood-red skin and solid black
  ...
  orcs() {
    return(
      <div>
        <h3>Orcs</h3>
        <p><span class="race-heading tooltip">Orcs*:&nbsp;<span class="tooltiptext">Orcs are not yet available as a playable class...</span></span>Orc culture 
        ...
        <p><span class="race-heading">Half-Orcs</span>: Decedents of humans who have interbred or been interbred with orcs.</p>
      </div>
    );
  }
  ...
  goblinoids() {
    return(
      <div>
        <h3>Goblinoids</h3>
        <p><span class="race-heading">Hobgoblins</span>:&nbsp;Standing nearly as tall as an average human, with lean and strong builds
        ...
        <p><span class="race-heading tooltip">Goblins*<span class="tooltiptext">Goblins are not yet available as a playable class...</span></span>:&nbsp;Wiry, cunning, and mischievous (and have the ability to breed almost
        ...
        <p><span class="race-heading tooltip">Bugbears*<span class="tooltiptext">Bugbears are not yet available as a playable class...</span></span>:&nbsp;
  ...
  lizardfolk() {
    return(
      <div>
        <h3>Lizardfolk</h3>
        <p><span class="race-heading">Swampfolk</span>: Dark green scales and a multi-color crest on the head identifies 
        ...
        <p><span class="race-heading">Marshfolk</span>: More likely to trade with outsiders than their swamp-dwelling
  ...
  yaunti() {
    return(
      <div>
        <h3>Yaun-Ti</h3>
        <p><span class="race-heading">Pureblood</span>: Believed decedents of those who worshiped, or were otherwise infused with the 
